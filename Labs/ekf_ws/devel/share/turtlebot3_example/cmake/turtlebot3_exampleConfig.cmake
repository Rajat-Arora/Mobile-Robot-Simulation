...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_example_SOURCE_PREFIX /home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/src/turtlebot3/turtlebot3_example)
  set(turtlebot3_example_DEVEL_PREFIX /home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/devel)
  ...
  set(turtlebot3_example_INSTALL_PREFIX /home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/install)
...
if(NOT "/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/devel/include " STREQUAL " ")
  set(turtlebot3_example_INCLUDE_DIRS "")
  set(_include_dirs "/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/src/turtlebot3/turtlebot3_example/${idir}'.  ${_report}")
    endif()
