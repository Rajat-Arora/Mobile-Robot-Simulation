...
echo_and_run cd "/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/src/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/src/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/rajat/robotics/Mobile-Robot-Simulation/Labs/ekf_ws/build/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
