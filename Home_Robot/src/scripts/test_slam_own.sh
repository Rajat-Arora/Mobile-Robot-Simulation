...
sleep 3
xterm  -e  " source /opt/ros/noetic/setup.bash; source /home/rajat/robotics/Mobile-Robot-Simulation/Home_Robot/devel/setup.bash; rosrun robot_state_publisher robot_state_publisher" &
